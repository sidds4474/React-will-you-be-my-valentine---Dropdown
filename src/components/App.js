...
const states = [{
	...
	city :[{
		...
		landmarks :[{
			...
			name: "Berasia",
			description:"Berasia is aimport React, { useState,useReducer } from "react";
import "./../styles/App.css";
...
export default App; landmark and a nagar palika in Bhopal district in the state of Madhya Pradesh, India. ",
		}]
	},{
		name : "Gwalior",
		description:"Gwalior is a city in the central Indian state of Madhya Pradesh. It's known for its palaces and temples, including the Sas Bahu Ka Mandir intricately carved Hindu temple. ",
